...
export function FacebookIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M13.5 21v-7.5h2.5l.5-3H13.5V8.5c0-.9.2-1.5 1.5-1.5H16.6V4.3c-.3 0-1.2-.1-2.3-.1-2.3 0-3.8 1.4-3.8 3.9V10.5H8v3h2.5V21h3z" />
    </svg>
  );
}
...
export function TwitterIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M4 4l7.2 9.6L4.4 20H6l6.1-5.7 4.4 5.7H20l-7.5-9.9L19 4h-1.6l-5.6 5.3L8 4H4z" />
    </svg>
  );
}
